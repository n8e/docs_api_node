...
let document1 = {
    ...
    content:
      'This is obtained from the base and height. Get half of' +
...
describe('Document', () => {
  it(
    'validates that one has to be authenticated to access documents ' +
      '(GET /api/documents)',
    (done) => {
...
describe('Document tests requiring authentication', () => {
  ...
  it(
    'validates that a document is created by a user logged in ' +
      '(POST /api/documents)',
    (done) => {
      request
        ...
        .end((err, res) => {
          ...
          expect(res.body.title).to.equal(document1.title);
          expect(res.body.content).to.equal(document1.content);
          done();
        });
    },
  );
    ...
    (done) => {
      request
        ...
        .end((err, res) => {
          ...
          expect(res.body).to.be.an('object');
          expect(res.body._id).not.to.be.undefined;
          expect(res.body.title).to.equal(document2.title);
          expect(res.body.content).to.equal(document2.content);
          done();
        });
    },
  );
  ...
  it(
    'validates that all documents, limited by a specified number ' +
  ...
  it(
    'validates that all documents, limited by a specified number, that were' +
...
describe('Administrator Documents', () => {
  ...
  it(
    'validates that a document is created by a admin logged in ' +
      '(POST /api/documents)',
    (done) => {
      request
        .post(url + '/api/documents')
        ...
        .end((err, res) => {
          ...
          expect(res.body).to.be.an('object');
          expect(res.body._id).not.to.be.undefined;
          expect(res.body.title).to.equal(document3.title);
          expect(res.body.content).to.equal(document3.content);
          done();
        });
    },
  );
    ...
    (done) => {
      request
        ...
        .end((err, res) => {
          ...
          expect(res.body).to.be.an('object');
          expect(res.body._id).not.to.be.undefined;
          expect(res.body.title).to.equal(document4.title);
          expect(res.body.content).to.equal(document4.content);
          done();
        });
    },
  );
  ...
  it(
    'validates that any users document can be updated by an ' +
  ...
  it(
    'validates that any users document can be deleted by an ' +
...
describe('Document tests requiring authentication', () => {
  ...
  it(
    'validates that a document can only be updated by the creator or an ' +
      'Administrator (PUT /api/documents/:id)',
    (done) => {
      request
        .put(url + '/api/documents/' + doc1id)
        ...
        .end((err, res) => {
          ...
          expect(res.body.message).to.equal(
            'Forbidden to update this document.',
          );
          done();
        });
    },
  ...
  it(
    'validates that a document can only be deleted by the creator or an ' +
      'Administrator (DELETE /api/documents/:id)',
    (done) => {
      request
        ...
        .end((err, res) => {
          ...
          expect(res.body).to.be.an('object');
          expect(res.body.message).to.equal(
            'Forbidden to delete this document.',
          );
          done();
        });
    },
